...
from Python_Web.hw40.src.schemas import SkillCreate, SkillUpdate, SkillResponse, SkillShortResponse
from Python_Web.hw40.src.repository import skills as repository_skills
