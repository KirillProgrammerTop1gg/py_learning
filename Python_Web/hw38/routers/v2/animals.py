...
from Python_Web.hw38.db import get_db
from Python_Web.hw38.schemas.v2 import AnimalCreateV2, AnimalResponseV2
from Python_Web.hw38.services.animals import create_animal_db, get_animal_db
